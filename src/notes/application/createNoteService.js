...
module.exports = class CreateNoteService {
  ...
  async createNoteForBook(note, bookId) {
    ...
    const createdNote =
        await this._noteRepository.createNoteForBook(note, bookId);

    /**
     * Cambiar para pushear la nota en vez del id,
     * crear un mapper para el repositorio, para recibiir entidades de mongodb
     * */
